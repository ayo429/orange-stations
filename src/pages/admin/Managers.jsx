                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-xs">{manager.email}</p>
                    </div>
                  </div>
                  <div className="flex gap-2">
                    <button
                      onClick={() => navigate(`/admin/station/${manager.id}`)}
                      className="bg-orange-500/15 text-orange-400 border border-orange-500/30 rounded-lg px-3 py-1.5 text-xs hover:bg-orange-500/25 transition"
                    >
                      View Station
                    </button>
                    <button
